...
class AITestFixtures:
    ...
    def get_security_test_data():
        ...
        return {
            ...
            'invalid_chars': {
                'content': ''.join(chr(i) for i in range(32))  # Control characters
            }
        }
    ...
    def get_edge_cases():
        ...
        return {
            ...
            'malformed_xml': {
                'content': '<rss><channel><item></channel></rss>'
            },
            'unicode_content': {
                'content': '测试内容'
            },
    ...
    def get_load_test_data(duration_seconds=3600):
        ...
        def generate_item(timestamp):
            return {
                ...
                'pubDate': datetime.fromtimestamp(timestamp).isoformat()
            }
