...
def test_categorizer_with_title(categorizer):
    ...
    assert any(kw.lower() in ["ai", "healthcare", "technology"] for kw in result.keywords)
    assert result.primary_category in [ContentCategory.HEALTH, ContentCategory.TECHNOLOGY]
...
def test_topic_extraction_basic(topic_analyzer):
    ...
    documents = [
        ...
        {"id": "3", "text": "Deep learning is a subset of machine learning in AI."},
        {"id": "4", "text": "Climate change is affecting global weather patterns."},
        {"id": "5", "text": "Global warming leads to extreme weather events."},
    ]
...
def test_topic_document_assignment(topic_analyzer):
    ...
    documents = [
        {"id": "1", "text": "New developments in artificial intelligence and machine learning."},
        {"id": "2", "text": "The latest AI algorithms show promising results."},
    ]
    ...
    assert all(0 <= score <= 1 for topics in result.document_topics.values() for _, score in topics)
...
def test_topic_trends(topic_analyzer):
    ...
    documents1 = [
        {"id": "1", "text": "AI technology is advancing rapidly."},
        {"id": "2", "text": "Machine learning models are becoming more sophisticated."},
    ]
    ...
    documents2 = documents1 + [
        {"id": "3", "text": "New breakthroughs in artificial intelligence research."},
        {"id": "4", "text": "AI and machine learning transform industries."},
    ]
...
def test_emerging_topics(topic_analyzer):
    ...
    # Initial documents
    initial_docs = [
        {"id": str(i), "text": f"Document {i} about artificial intelligence."} for i in range(3)
    ]
    ...
    emerging_docs = initial_docs + [
        {"id": str(i), "text": f"Document {i} about quantum computing."} for i in range(3, 8)
    ]
...
def test_related_topics(topic_analyzer):
    ...
    documents = [
        # AI/ML cluster
        {"id": "1", "text": "Artificial intelligence and machine learning advances."},
        {"id": "2", "text": "Deep learning models in AI applications."},
        # Data Science cluster
        {"id": "3", "text": "Data science and statistical analysis methods."},
        {"id": "4", "text": "Machine learning in data science applications."},
    ]
...
def test_topic_coherence(topic_analyzer):
    ...
    documents = [
        ...
        {"id": "2", "text": "Advanced Python programming techniques."},
        # Less coherent cluster
        {"id": "3", "text": "Weather patterns and climate change."},
        {"id": "4", "text": "Economic impact of environmental policies."},
    ]
