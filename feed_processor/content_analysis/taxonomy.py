...
class CategoryTaxonomy:
    ...
    def _initialize_taxonomy(self):
        ...
        tech = self._add_category("technology", keywords={
            "software", "hardware", "programming", "artificial intelligence",
            "machine learning", "cybersecurity", "blockchain", "cloud computing"
        })
        self._add_category("ai", parent=tech, keywords={
            "machine learning", "deep learning", "neural networks",
            "artificial intelligence", "nlp", "computer vision"
        })
        self._add_category("cybersecurity", parent=tech, keywords={
            "security", "hacking", "encryption", "privacy", "cyber attack",
            "malware", "ransomware", "data breach"
        })
        
        # Business categories
        business = self._add_category("business", keywords={
            "finance", "economy", "market", "startup", "investment",
            "entrepreneurship", "management", "strategy"
        })
        self._add_category("finance", parent=business, keywords={
            "investing", "stock market", "cryptocurrency", "banking",
            "financial markets", "trading", "investment"
        })
        self._add_category("startups", parent=business, keywords={
            "startup", "venture capital", "entrepreneurship", "funding",
            "seed round", "series a", "angel investor"
        })
        
        # Science categories
        science = self._add_category("science", keywords={
            "research", "discovery", "experiment", "scientific",
            "innovation", "laboratory", "study"
        })
        self._add_category("physics", parent=science, keywords={
            "quantum", "particle physics", "theoretical physics",
            "astrophysics", "physics research"
        })
        self._add_category("biology", parent=science, keywords={
            "genetics", "molecular biology", "evolution", "cell biology",
            "biotechnology", "microbiology"
        })
        
        # Add more categories as needed...
    
    def _add_category(self, name: str, parent: Optional[CategoryNode] = None,
                     keywords: Optional[Set[str]] = None) -> CategoryNode:
