...
from feed_processor.errors import ValidationError
        ...
        try:
            ...
            if root.tag == "rss":
                ...
                parsed = {
                    ...
                    if channel.find("pubDate") is not None else None,
                    "entries": [{
                        "title": item.find("title").text,
                        "link": item.find("link").text,
                        "summary": item.find("description").text
                        if item.find("description") is not None else None,
                        "updated": parse_date(item.find("pubDate").text)
                        if item.find("pubDate") is not None else None
